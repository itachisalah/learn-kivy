...
def intro_loop():
    ...
    while intro:
        ...
        textSurf, textRect = text_objects(" BY: salah itachi ", smalltext)
...
def introduction():
    ...
    while introduction:
        ...
        lagetext= pygame.font.Font('freesansbold.ttf',80)
        smalltext= pygame.font.Font('freesansbold.ttf', 20)
        mediumtext= pygame.font.Font('freesansbold.ttf',40)

        TextSurf,TextRect = text_objects("INSTRUCTIONS", lagetext)
        TextRect.center=((400),(100))
        ...
        sTextSurf, sTextRect = text_objects("COUNTROLS", mediumtext)
...
def paused():
    ...
    while pause:
            ...
            gamedisplays.blit(TExtSurf,TextRect)
            button("CONTINUE",150,450,150,50, green, bright_green,"unpase")
            button("RESTART",350,450.150,50,blue,bright_blue,"ply")
