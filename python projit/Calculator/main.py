...
class CalcWindow(BoxLayout):
    def __init__(self, **kwargs):
        ...
        eq = Button(text='=', size_hint_y=.25, background_color=(0.133, 0.855, 0.431, 1.0), background_normal='',
                    font_size=26)
        ...
        for num in syms2:
            ...
            if num == '+':
                btn_height = .5
            btn = Button(text=str(num), size_hint_y=btn_height, background_normal='',
                         background_color=(0.004, 0.055, 0.102, 1.0), font_size=26)
            btn.bind(on_release=self.echo_num)
